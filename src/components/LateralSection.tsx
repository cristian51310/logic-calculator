  ...
  return (
    <React.Fragment>
      <div className="relative overflow-hidden flex w-5/12 bg-gradient-to-tr from-blue-400 to-purple-300 dark:from-blue-900 dark:to-purple-800 justify-around items-center text-gray-800/90 dark:text-white transition duration-300">
        <div>
          <h1 className=" font-bold text-4xl font-sans mt-4">Logic Calculator</h1>
          <p className=" mt-2 mb-10 text-center">La mejor calculadora preposicional</p>
          ...
          <ThemeSwitch position={'absolute bottom-20 left-80'}/>
          <LanguageSwitch position={'absolute bottom-8 left-80'}/>
